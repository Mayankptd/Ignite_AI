...
def camera():
    ...
    tk.Button(root,text="Quit",fg="red",command=root.destroy,font=('arial',25,'bold')).place(relx=0.5,rely=0.8)
    tk.Button(root,text="start",fg="green",command=show_vid,font=('arial',25,'bold')).place(relx=0.4,rely=0.8)
    # show_vid()
    # show_avatar()
    root.mainloop()
